...
export function DinoDexHeader() {
  ...
  return (
    <div className="mb-6">
      ...
      <p className="mt-4 text-lg text-muted-foreground">Complete encyclopedia of all dinosaur species</p>
      <div className="mt-2 flex flex-wrap gap-4 text-sm">
        <div className="flex items-center gap-2">
          <div className="h-3 w-3 rounded-full bg-green-500" />
          <span className="text-muted-foreground">{isMounted ? `${discoveredCount} Discovered` : 'Loading...'}</span>
        </div>
        <div className="flex items-center gap-2">
